...
{
    public class WheelController : MonoBehaviour //BaseController
    {
        ...
        public void StartGame(ZoneData zoneData)
        {
            ...
            _rewardSelectController = new RewardSelectController(zoneData.RandomRewards); 
        
            List<RewardData> selectedRewards = _rewardSelectController.GetRewardDatas();
            
            _wheelAnimationController = new WheelAnimationController(_wheelContainer, _wheelSettings, selectedRewards.Count);
